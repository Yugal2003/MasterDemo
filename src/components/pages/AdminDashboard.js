...
//                         </li> */}
//                         <li className="border-2 border-b-white py-3 cursor-pointer">
//                             <Link to={`/admin-dashboard/${adminId}/myprofile`} className="flex items-center gap-2"><FaRegUser />My Profile</Link>
//                         </li>
//                         <li className="border-2 border-b-white py-3 cursor-pointer">
//                             <Link to={`/admin-dashboard/${adminId}/studentManage`} className="flex items-center gap-2"><FaWpforms />Student Management</Link>
//                         </li>
//                         <li className="border-2 border-b-white py-3 cursor-pointer">
//                             <Link to={`/admin-dashboard/${adminId}/HODManage`} className="flex items-center gap-2"><FaWpforms />HOD Management</Link>
//                         </li>
//                         <li className="border-2 border-b-white py-3 cursor-pointer">
//                             <Link to={`/admin-dashboard/${adminId}/viewLeaveReport`} className="flex items-center gap-2"><HiOutlineDocumentReport />View Leave Report</Link>
//                         </li>
//                         <li className="border-2 border-b-white py-3 cursor-pointer">
