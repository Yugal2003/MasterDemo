...
// code with responsive style => perfect
...
//                 toast.success(`Welcome, ${userData.name || userData.role.toUpperCase()}`);
//                 login(userData);
...
//                     : userData.role === 'hod'
//                     ? `/hod-dashboard/${userData.id}`
//                     : `/student-dashboard/${userData.id}`;
